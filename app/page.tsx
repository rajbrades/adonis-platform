...
import { ArrowRight, Zap, TrendingUp, Sparkles, Shield, Heart, Clock, Brain } from 'lucide-react'
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl md:text-6xl font-bold text-center mb-16 text-white">
            {brand.whyUs.sectionTitle.split(' ')[0]} <span style={{ color: brand.colors.primary }}>{brand.whyUs.sectionTitle.split(' ')[1]}</span>
          </h2>
