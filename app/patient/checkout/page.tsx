      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
            ...
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-3">
                <div className="text-right">
                  ...
                  <div className="text-xs text-white/60">Checkout</div>
                </div>
        ...
        <div className="flex items-center justify-center min-h-[80vh]">
          <div className="text-center max-w-md">
            ...
            <p className="text-white/60 mb-8">Add lab panels to your cart before checking out</p>
            <Link
              href="/patient/cart"
                ...
                <div className="mt-6 bg-blue-500/10 border border-blue-500/20 rounded-xl p-4">
                  ...
                  <div className="space-y-3 text-xs text-white/80">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <p>Results ready in 5-7 days, then we will schedule your consultation call</p>
                    </div>
                  </div>
                </div>
