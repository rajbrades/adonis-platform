  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 border border-yellow-500/20 rounded-xl p-8 mb-16">
            ...
            <Link 
              ...
              className="inline-flex items-center text-yellow-400 hover:text-yellow-300 font-bold text-lg"
            >
              Read Full Article
              ...
              <button
                ...
                className={`px-6 py-2 rounded-full border transition-all ${
                  index === 0
                    ...
                    : 'text-white border-yellow-500/20 hover:border-yellow-400/50 hover:text-yellow-400'
                }`}
              >
                {category}
              </button>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <article key={index} className="bg-white/5 border border-yellow-500/20 rounded-xl overflow-hidden hover:border-yellow-400/40 transition-all group">
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Link 
                      href={`/blog/${post.slug}`}
                      className="text-yellow-400 hover:text-yellow-300 font-medium text-sm inline-flex items-center"
                    >
                      Read More
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-400/10 to-yellow-600/10 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-black mb-6 text-yellow-400">Stay Informed</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <input
              ...
              className="flex-1 bg-white/10 border border-yellow-500/20 rounded-lg px-4 py-3 text-white placeholder-white/50 focus:border-yellow-400 focus:outline-none"
            />
            <button className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-8 py-3 rounded-lg font-bold hover:shadow-lg transition-all">
              Subscribe
            </button>
          </div>
        </div>
