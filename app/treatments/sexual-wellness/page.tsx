      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-black mb-6">
            Sexual Wellness & <span className="text-yellow-400">Performance</span>
          </h1>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-12 text-center">
            <h2 className="text-4xl font-black mb-6">Restore Your <span className="text-yellow-400">Confidence</span></h2>
            <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
              Comprehensive solutions for sexual wellness and performance optimization.
            </p>
            <Link 
              href="/consultation"
