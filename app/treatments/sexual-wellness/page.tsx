    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[oklch(90.5%_0.182_98.111/0.1)] border border-[oklch(90.5%_0.182_98.111)]/30 rounded-full px-4 py-2 mb-6">
                <Heart className="w-4 h-4 " style={{ color: brand.colors.primary }} />
                <span className="text-sm font-semibold " style={{ color: brand.colors.primary }}>SEXUAL WELLNESS</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-black mb-6">
                Optimize Your <span className="" style={{ color: brand.colors.primary }}>Sexual</span> Performance
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Reclaim Your <span className="" style={{ color: brand.colors.primary }}>Confidence</span>
            </h2>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="md:col-span-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mb-6">
                      ...
                      <div className="bg-white/5 rounded-xl p-4">
                        <div className="flex items-center gap-2 mb-3">
                          <Timer className="w-5 h-5 " style={{ color: brand.colors.primary }} />
      ...
      <section className="py-24 px-6 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Quick <span className="" style={{ color: brand.colors.primary }}>Comparison</span>
            </h2>
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
            ...
            <table className="w-full">
              ...
              <tbody>
                <tr className="border-b border-white/5 hover:bg-white/5 transition">
                  <td className="py-4 px-6  font-semibold" style={{ color: brand.colors.primary }}>Tadalafil</td>
                ...
                <tr className="border-b border-white/5 hover:bg-white/5 transition">
                  <td className="py-4 px-6  font-semibold" style={{ color: brand.colors.primary }}>Tadalafil + Oxytocin</td>
                  <td className="py-4 px-6 text-white/70">30-60 min</td>
                  <td className="py-4 px-6 text-white/70">Up to 36 hours</td>
                  <td className="py-4 px-6 text-white/70">Enhanced intimacy</td>
                </tr>
                <tr className="border-b border-white/5 hover:bg-white/5 transition">
                  <td className="py-4 px-6  font-semibold" style={{ color: brand.colors.primary }}>Sildenafil</td>
                  <td className="py-4 px-6 text-white/70">30-60 min</td>
                  <td className="py-4 px-6 text-white/70">4-6 hours</td>
                  <td className="py-4 px-6 text-white/70">Planned intimacy</td>
                </tr>
                <tr className="border-b border-white/5 hover:bg-white/5 transition">
                  <td className="py-4 px-6  font-semibold" style={{ color: brand.colors.primary }}>Tadalafil + Apomorphine</td>
                  <td className="py-4 px-6 text-white/70">15-30 min</td>
                  <td className="py-4 px-6 text-white/70">Up to 36 hours</td>
                  <td className="py-4 px-6 text-white/70">ED + low desire</td>
                </tr>
                <tr className="hover:bg-white/5 transition">
                  <td className="py-4 px-6  font-semibold" style={{ color: brand.colors.primary }}>PT-141</td>
