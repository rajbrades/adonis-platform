    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[oklch(90.5%_0.182_98.111/0.1)] border border-[oklch(90.5%_0.182_98.111)]/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-semibold " style={{ color: brand.colors.primary }}>NATURAL OPTIMIZATION</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-black mb-6">
                Natural <span className="" style={{ color: brand.colors.primary }}>Testosterone</span> Boosters
              </h1>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6 " style={{ color: brand.colors.primary }}>Why Choose Natural Boosters?</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Why Natural <span className="" style={{ color: brand.colors.primary }}>Optimization?</span>
            </h2>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              <span className="" style={{ color: brand.colors.primary }}>Optimization</span> Options
            </h2>
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
      ...
      <section className="py-24 px-6 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Natural Boosters vs <span className="" style={{ color: brand.colors.primary }}>TRT</span>
            </h2>
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              <div className="bg-[oklch(90.5%_0.182_98.111/0.1)] w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                <Zap className="w-7 h-7 " style={{ color: brand.colors.primary }} />
              </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-[${brand.colors.primary}]/10 to-[${brand.colors.primaryDark}]/10 backdrop-blur-sm border border-[oklch(90.5%_0.182_98.111)]/20 rounded-2xl p-8 text-center">
            <Baby className="w-12 h-12  mx-auto mb-4" style={{ color: brand.colors.primary }} />
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-4xl font-black mb-6">
                Is Natural Optimization <span className="" style={{ color: brand.colors.primary }}>Right for You?</span>
              </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                <Baby className="w-12 h-12  mb-4" style={{ color: brand.colors.primary }} />
