    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[oklch(90.5%_0.182_98.111/0.1)] border border-[oklch(90.5%_0.182_98.111)]/30 rounded-full px-4 py-2 mb-6">
                <Zap className="w-4 h-4 " style={{ color: brand.colors.primary }} />
                <span className="text-sm font-semibold " style={{ color: brand.colors.primary }}>HORMONE OPTIMIZATION</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-black mb-6">
                Injectable <span className="" style={{ color: brand.colors.primary }}>Testosterone</span> Replacement
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Transform Your <span className="" style={{ color: brand.colors.primary }}>Performance</span>
            </h2>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black mb-6">
              Choose Your <span className="" style={{ color: brand.colors.primary }}>Protocol</span>
            </h2>
            <p className="text-xl text-white/60 max-w-3xl mx-auto">
            ...
            {protocols.map((protocol, idx) => (
              ...
              >
                <div className="bg-[oklch(90.5%_0.182_98.111/0.1)] w-14 h-14 rounded-xl flex items-center justify-center mb-6">
                  <Syringe className="w-7 h-7 " style={{ color: brand.colors.primary }} />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 text-sm">
                    <TrendingUp className="w-5 h-5 " style={{ color: brand.colors.primary }} />
          ...
          {/* Carrier Oils */}
          <div className="bg-gradient-to-r from-[${brand.colors.primary}]/10 to-[${brand.colors.primaryDark}]/10 backdrop-blur-sm border border-[oklch(90.5%_0.182_98.111)]/20 rounded-2xl p-8 mb-8">
            <div className="flex items-start gap-4 mb-6">
              <Droplet className="w-8 h-8  flex-shrink-0" style={{ color: brand.colors.primary }} />
              <div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {carrierOils.map((oil, idx) => (
                <div key={idx} className="bg-white/5 rounded-xl p-6">
                  <h4 className="text-xl font-bold mb-3 " style={{ color: brand.colors.primary }}>{oil.name}</h4>
                  ...
                  <div className="space-y-2">
                    {oil.features.map((feature, fidx) => (
                      <div key={fidx} className="flex items-center gap-2 text-sm text-white/70">
                        <div className="w-1.5 h-1.5 rounded-full bg-white" style={{ backgroundColor: brand.colors.primary }}></div>
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-4xl font-black mb-6">
                Is TRT <span className="" style={{ color: brand.colors.primary }}>Right for You?</span>
              </h2>
              ...
              <div className="space-y-4 mb-8">
                ...
                {[
                  ...
                  <div key={idx} className="flex items-start gap-3">
                    <AlertCircle className="w-5 h-5  flex-shrink-0 mt-0.5" style={{ color: brand.colors.primary }} />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                <Heart className="w-12 h-12  mb-4" style={{ color: brand.colors.primary }} />
