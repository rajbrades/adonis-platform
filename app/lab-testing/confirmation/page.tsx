            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    Within 1-2 business days, you will receive your lab requisition form and detailed instructions for sample collection.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-300">
                    Results typically arrive within 14 business days. We will email them to you as soon as they are ready.
                  </p>
                </div>
              </div>
            </div>
